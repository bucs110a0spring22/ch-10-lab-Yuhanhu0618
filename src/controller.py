...
class Controller:
    def __init__(self, width=640, height=480):
      ''' 
      Inicialize the screnn, the hero, and the enemy
	    args: (int) Screen width & height
	    return: None
      '''
      pygame.init()
      self.width = width
    ...
    def mainLoop(self):
      ''' 
      Dtectes if game is over or not.
	    args: None
	    return: None
      '''
      while True:
    ...
    def gameLoop(self):
      ''' 
      Detects the input of the user and collision of heor and enemy. Generate fights based on them.
	    args: None
	    return: None
      '''
      while self.state == "GAME":
          ...
          self.enemies.update(self.hero.rect.x, self.hero.rect.y)
